...
+(function(window, $, undefined) {
	 ...
	 */
	 ...
	 $.fn.rrssb = function( options ) {
		...
		var settings = $.extend({
			description: $('meta[name=gen-description]').attr("content"),
			emailAddress: undefined,
			emailBody: undefined,
			emailSubject: undefined,
			image: $('meta[name=gen-image]').attr("content"),
			title: $('meta[name=gen-title]').attr("content"),
			url: $('meta[name=gen-url]').attr("content")
		}, options );
