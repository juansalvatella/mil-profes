            ...
            <div class="col-xs-12 col-sm-offset-2 col-sm-8">
                ...
                <form class="form-horizontal" action="{{ action('TeachersController@saveLesson') }}" method="post" role="form" id="edit-l-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" pattern="^([0-9\.,]){0,}$" class="form-control" name="price" id="price" placeholder="¿Cuál será el precio por hora de tu clase?"  value="{{ $lesson->price }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="¿Dónde darás la clase?" class="form-control" name="address" id="address" value="{{ $lesson->address }}" required="required"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="2" class="form-control" name="description" id="description" placeholder="Describe los contenidos de tu clase" required="required" maxlength="200">{{ $lesson->description }}</textarea>
