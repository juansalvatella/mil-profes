...
@section('content')
    ...
    <div class="container-fluid top-padding-70 bottom-padding-150 background-lamp">
        <div class="container">
            ...
            <div class="generic-title"><h3>@lang('faqs.title')</h3></div>

            <div class="generic-subtitle">@lang('faqs.subtitle')</div>
        ...
        <div class="container generic-box top-padding-50 bottom-padding-50 magic-align">
            ...
            <div class="col-xs-offset-0 col-xs-12 col-sm-offset-2 col-sm-8">
                ...
                <div class="row text-center">
                    <a href="{{ url('contactanos') }}" class="btn btn-primary input-lg faqs-btn">@lang('faqs.doubts')</a>
                </div>
            </div>
        </div>
    </div>
