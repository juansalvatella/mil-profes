$(document).ready(function() {
    ...
    function denyConsent() {
        setCookie("Consent denied", "No consientes el uso de cookies.", "false");
    }

    function grantConsent() {
        if (consentIsSet == "true") return; // Don't grant twice
        setCookie("Consent granted", "Gracias por consentir el uso de cookies.", "true");
        doConsent();
    }
    ...
    function analytics() {
        ...
        ga('create', 'UA-752819-15', 'milprofes.com');
        ga('send', 'pageview');
    }
    ...
    if (consentIsSet == "unknown") {    
        ...
        if (pageName != "politica-de-privacidad") $(window).scroll(grantConsent); // XXX you may edit this name
